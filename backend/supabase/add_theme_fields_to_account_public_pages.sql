...
COMMENT ON COLUMN account_public_pages.custom_primary_color IS 'Custom primary/brand color (hex) for public pages';
COMMENT ON COLUMN account_public_pages.custom_secondary_light_color IS 'Custom secondary color for light theme (hex)';
COMMENT ON COLUMN account_public_pages.custom_background_light_color IS 'Custom background color for light theme (hex)';
COMMENT ON COLUMN account_public_pages.custom_text_color IS 'Custom text/foreground color for light theme (hex)';
