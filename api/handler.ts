...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    console.log('✅ Express app loaded, passing request...');
    
    // Pass the request directly to Express without modification
    // Express will handle routing based on how it's mounted
    return app(req, res);
  } catch (error: any) {
